...
// the max value of this array is 9999
    static int[] array = {1, 34, 5, 6, 343, 5, 63, 5, 34, 2, 78, 2, 3, 4, 5,
            234, 678, 543, 45, 67, 43, 2, 3, 4543,
            234, 3, 454, 1, 2, 3, 1, 9999, 34, 5, 6, 343, 5, 63, 5, 34, 2,
            78, 2, 3, 4, 5, 234, 678, 543, 45, 67, 43, 2,
            3, 4543, 234, 3, 454, 1, 2, 3, 1, 34, 5, 6, 5, 63, 5, 34, 2, 78,
            2, 3, 4, 5, 234, 678, 543, 45, 67, 43, 2,
...
// this is a single threaded version
        ...
        multiThread one  = new multiThread(0, 29);
        multiThread two = new multiThread(30, 50);
        multiThread three = new multiThread(60, 89);
        one.start();
        two.start();
        three.start();
        try {
        ...
        int max = Math.max(one.result, Math.max(two.result, three.result));
...
// you should NOT change this function
    ...
    class multiThread extends Thread{
        ...
        private int end;
        public int result;
        public multiThread(int begin, int end){
            this.begin = begin;
            this.end = end;
        }
        @Override
